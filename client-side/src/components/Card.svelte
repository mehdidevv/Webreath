<script>
  export let name, description, created_at;
</script>
      ...
      <div class="widget-49">
        <div class="widget-49-title-wrapper">
          <div class="widget-49-date-primary">
            <img
              src="https://www.mouser.fr/images/marketingid/2017/img/176779579.png?v=091321.0145"
              alt="user"
              style="width: 70px;"
            />
          </div>
          <div class="widget-49-meeting-info">
            <span class="widget-49-pro-title">{name}</span>
            <span class="widget-49-meeting-time">{created_at}</span>
          </div>
        </div>
